...
This is a project using Next.js 15 applications with Firebase.

## Features

- Realtime AI Chatbot using gemini-1.5-flash model
...
This project was created using the Next.js framework and Firebase platform and Google AI studio.
